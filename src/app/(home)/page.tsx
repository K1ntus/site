      ...
      <div className="max-w-3xl mx-auto text-center space-y-6 relative">
        ...
        <div className="w-64 h-1 bg-orange-300 mx-auto rounded-sm" />
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            <Link
              href="/docs"
              className="inline-flex items-center gap-3 px-4 py-2 text-base md:text-lg rounded-md
                        bg-[#422914] text-[#FFC478]
                        transition-colors duration-150 ease-in-out
                        hover:bg-[#5b361a] focus:bg-[#5b361a] focus:outline-none"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-base md:text-lg rounded-md
                        bg-[#2B2D4B] text-[#81A0BE]
                        transition-colors duration-150 ease-in-out
                        hover:bg-[#3a3d67] focus:bg-[#3a3d67] focus:outline-none"
            >
              {/* Discord Icon */}
              <svg
                width="3em"
